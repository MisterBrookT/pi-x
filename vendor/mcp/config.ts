...
/**
 * Pix modification: no suggested third-party servers.
 *
 * Setup still writes, imports, and manages any server the user adds; only the
 * upstream vendor menu is gone. Installing by URL through `mcp` is unchanged.
 */
